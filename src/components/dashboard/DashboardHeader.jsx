    ...
    <div>
      ...
      <div className="flex items-center justify-center relative py-3">
        ...
        <div className="text-center">
          <h1 className="text-3xl font-bold leading-tight" style={{ fontFamily: '"Happy Monkey", cursive' }}>WESTWOOD ELEMENTARY</h1>
          <p className="text-sm font-bold leading-tight mt-0.5">FORMULARIO DE INFORMACIÓN DEL ESTUDIANTE</p>
        </div>
      </div>
