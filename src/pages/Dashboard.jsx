    ...
    <div className="min-h-screen bg-gradient-to-br from-sky-100 to-blue-50 p-3 sm:p-6">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col gap-3 mb-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex gap-2 overflow-x-auto flex-nowrap -mx-1 px-1 pb-1 sm:flex-wrap sm:overflow-visible">
            {assignMode ? (
              <>
                <input
                  value={assignClass}
              ...
              <>
                <Link
                  to="/TeacherHub"
                  className="text-sm bg-indigo-600 text-white rounded-lg px-4 py-2 hover:bg-indigo-700 shrink-0"
                >
                  👩‍🏫 Teacher Hub
                </Link>
                <button
                  onClick={() => setAssignMode(true)}
                  className="text-sm bg-blue-600 text-white rounded-lg px-4 py-2 hover:bg-blue-700 shrink-0"
                >
                  Assign Classes
                </button>
                <Link
        ...
        {/* Class tabs */}
        <div className="flex gap-2 overflow-x-auto flex-nowrap mb-3 pb-1 sm:flex-wrap sm:overflow-visible">
          {classes.map(cls => (
            <button
              key={cls}
        ...
        {/* Mode filter */}
        <div className="flex gap-2 overflow-x-auto flex-nowrap mb-5 pb-1 sm:flex-wrap sm:overflow-visible">
